...
var fedoraLinux = &distro{
	...
	rename: map[string]string{
		// Installer bootstrap/toolchain.
		"base-devel": "gcc",
		"rust":       "rust",

		// Fedora owns the host kernel/boot chain. Do not translate Arch's
		// kernel-header/DKMS assumptions into host mutations during the shell port.
		"linux-headers": "",
		"dkms":          "",
